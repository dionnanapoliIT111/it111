...
String name = "Dionna"; // after a statement, don't forget the semi colon!
        int hours = 40; // we are assigning 40 to the hours varaible
...
//        String building = "Empire State"; tree = "Redwood"; lake = "Lake Superior"; ocean = "Pacific Ocean";
